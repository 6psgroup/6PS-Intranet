...
//				header("Content-type: image/".$this->_format);
		...
		*/
		...
		function _codaBarcode($barnumber,$scale=1,$file="")
		{
			...
			//imagettftext($im, $scale*4, 0, $x+12, $height2-34, $bar_color, $this->_font , $barnumber);
			
			imagettftext($im, $scale*5, 0, 5, $height2-28, $bar_color, $this->_font , $this->label);
			/*
			if($this->label !== NULL || $this->label != '') {
				$this->imagettftextwrap($im, $scale*5, 0, 5, $height2-31, $bar_color, $this->_font , $this->label);
